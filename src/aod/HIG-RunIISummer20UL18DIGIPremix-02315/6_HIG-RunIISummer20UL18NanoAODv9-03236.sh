...
# cmsDriver command
cmsDriver.py  --python_filename HIG-RunIISummer20UL18NanoAODv9-03236_1_cfg.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:HIG-RunIISummer20UL18NanoAODv9-03236.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step NANO --filein "dbs:/WplusH_HToCC_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM" --era Run2_2018,run2_nanoAOD_106Xv2 --no_exec --mc -n $EVENTS || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18NanoAODv9-03236_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18NanoAODv9-03236_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18NanoAODv9-03236_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18NanoAODv9-03236 sequence 1/1"
