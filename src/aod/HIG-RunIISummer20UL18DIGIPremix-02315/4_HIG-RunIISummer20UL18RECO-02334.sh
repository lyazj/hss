...
# cmsDriver command
cmsDriver.py  --python_filename HIG-RunIISummer20UL18RECO-02334_1_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:HIG-RunIISummer20UL18RECO-02334.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:HIG-RunIISummer20UL18HLT-02334.root --era Run2_2018 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18RECO-02334_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18RECO-02334_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18RECO-02334_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18RECO-02334 sequence 1/1"
